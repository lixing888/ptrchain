...
public class ExcelUtil {
     ...
     * @return Excel 数据 list
     */
    public static List<Object> readExcel(String filePath, BaseRowModel rowModel) {
        ExcelListener excelListener = new ExcelListener();
    ...
    public static ExcelWriterFactroy writeExcelWithSheets(List<? extends BaseRowModel> list,
                                                          String fileName, String sheetName, BaseRowModel object) throws FileNotFoundException {
        ExcelWriterFactroy writer = new ExcelWriterFactroy(getFileOutputStream(), ExcelTypeEnum.XLSX);
        Sheet sheet = new Sheet(1, 0, object.getClass());
        sheet.setSheetName(sheetName);
        writer.write(list, sheet);
        return writer;
     ...
     * @param excelListener new ExcelListener()
     */
    protected static ExcelReader getReader(String filePath,
     ...
     * 返回 ExcelReader
     *
     * @param inputStream      需要解析的 Excel 流
     * @param excelListener new ExcelListener()
     */
    protected static ExcelReader getReader(InputStream inputStream,
                                           AnalysisEventListener excelListener) {
