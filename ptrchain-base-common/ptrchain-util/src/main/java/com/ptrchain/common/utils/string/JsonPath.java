...
//            
                ...
                if (ch == '.' || ch == '/') {
                    ...
                    if (ch == '(') {
                        ...
                        if (ch == ')') {
                            ...
                            } else if ("cnNumMax".equals(propertyName)) {
                                return CnNumMaxSegment.instance;
                            } else if ("cnNumMin".equals(propertyName)) {
                                return CnNumMinSegment.instance;
                            }
        ...
        public Object eval(JsonPath path, Object rootObject, Object currentObject) {
            ...
            if (currentObject instanceof Collection) {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (max == null) {
                        max = next;
                    } else if (compare(max, next,"MAX") < 0) {
                        max = next;
                    }
                }
            } else {
    ...
    static class CnNumMaxSegment extends MaxSegment {
        
        public final static CnNumMaxSegment instance = new CnNumMaxSegment();
        
        public Object eval(JsonPath path, Object rootObject, Object currentObject) {
            Object max = super.eval(path,rootObject,currentObject);
            
            return StringUtils.addUnit(new BigDecimal(String.valueOf(max)));
        }
        ...
        public Object eval(JsonPath path, Object rootObject, Object currentObject) {
            ...
            if (currentObject instanceof Collection) {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (min == null) {
                        min = next;
                    } else if (compare(min, next,"MIN") > 0) {
                        min = next;
                    }
                }
            } else {
    ...
    static class CnNumMinSegment extends MinSegment {
        
        public final static CnNumMinSegment instance = new CnNumMinSegment();
        
        public Object eval(JsonPath path, Object rootObject, Object currentObject) {
            Object min = super.eval(path,rootObject,currentObject);
            
            return StringUtils.addUnit(new BigDecimal(String.valueOf(min)));
        }
    ...
    static int compare(Object a, Object b, String type) {
