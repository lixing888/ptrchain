...
import static com.ptrchain.common.utils.file.Base64ImageUtil.readInputStream;
...
public class FileUtil {
    ...
    public static void main(String[] args) {
        //System.out.println(isFileExist("/Users/haijunsun/temp23.jpg"));
        //System.out.println(makeDirectory("/Users/haijunsun/xiaoxiao/xx/"));
        //System.out.println(emptyDirectory("/Users/haijunsun/tt"));
        //System.out.println(deleteDirectory("/Users/haijunsun/tt"));
        //List<String> list = readFileByLines("/Users/haijunsun/plan_report_template_info.sql");
        //list.stream().forEach(System.out::println);
        //System.out.println(SaveFileAs("孙海军\r\n","D:\\123.txt",true));
        List<String> list = readFileByLines("/Users/haijunsun/data2.json");
        list.stream().forEach(v -> {
            JSONObject obj = JSONObject.parseObject(v);
            String prod_name = (String)JSONPath.read(obj.toString(),"$.data.prod_name");
            String fileName = (String)JSONPath.read(obj.toString(),"$.data.term_file_name");
            String url = (String)JSONPath.read(obj.toString(),"$.data.term_file_url");
            if(!StringUtils.isNullOrEmpty(url)&&url.indexOf("null")<0){
                downloadHttpUrl(url,"/Users/haijunsun/0402/",fileName);
            }
        });
       *//* try {
            genModuleTpl("/Users/haijunsun/plan_report_template_info.sql","孙海军22222222");
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        try {
            FileInputStream fis = new FileInputStream("/Users/haijunsun/plan_report_template_info.sql");
            System.out.println("*****");
            System.out.println(readFile(fis));
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        }*//*
        //downLoadFromUrl("https://www.yixinbaoxian.com/epolicy/document/download?fileCode=cb3d6cb74a0242f797e9d7f43868d078","/Users/haijunsun/","11.pfg");
        //downloadHttpUrl("https://static.statickksmg.com/image/2019/04/02/03b094bd5884d6be1d5e1ad3675af640.jpg","/Users/haijunsun/","03b094bd5884d6be1d5e1ad3675af640.jpg");
    }*/
     ...
     * @return
     */
    public static boolean SaveFileAs(String content, String path, Boolean append) {
        FileWriter fw = null;
        try {
    ...
    public static void downLoadFile(HttpServletResponse response, String fileName, InputStream inputStream) {
        ...
        try {
            ...
            log.error("down lord attachment error,fileName:{},detail:{}", fileName, ExceptionUtils.getMessage(e));
